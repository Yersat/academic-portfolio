      ...
      <aside className="w-64 bg-slate-900 text-white flex flex-col fixed inset-y-0 z-50">
        <div className="p-6 border-b border-slate-800">
          <h1 className="text-xl font-bold flex items-center gap-2">
            <Settings size={20} className="text-blue-400" /> Управление
          </h1>
        </div>
        ...
        <div className="p-4 border-t border-slate-800 space-y-4">
           <div className="flex items-center gap-3 px-4">
             ...
             <div className="text-xs">
               ...
               <p className="text-slate-500">Управление сайтом</p>
             </div>
           </div>
           <button
      ...
      <main className="ml-64 flex-1 min-h-screen flex flex-col">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-40">
           <h2 className="font-bold text-slate-700">
             {navItems.find(n => isActive(n.path))?.name || 'Администрирование'}
           </h2>
