    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-sm shadow-2xl">
        <div className="text-center">
           ...
           <h1 className="text-2xl font-serif font-bold text-slate-900">Вход в панель управления</h1>
           <p className="text-slate-500 mt-2 text-sm font-medium">Введите пароль администратора для доступа к управлению порталом.</p>
        </div>

        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          <div className="space-y-1">
            <label className="text-xs uppercase font-bold tracking-widest text-slate-400">Пароль</label>
            <input
              type="password"
              value={password}
